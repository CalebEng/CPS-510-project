...
/*
creates a view showing what a valet should see when accessing the database
*/
create view VALET_VIEW as 
SELECT CUSTOMER.NAME, CUSTOMER.ID, VALET.L_PLATE,VALET.SPOT_NUMB,PARKED.E_ID 
FROM CUSTOMER
INNER JOIN VALET ON CUSTOMER.ID = VALET.ID
WHERE CUSTOMER.VALET =1;
